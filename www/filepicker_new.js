(function () {
    ...
    else for (attr in a) window.filepicker[attr] = a[attr];
})();
filepicker.extend("ajax", function () {
    ...
    var f = function (b, c) {
        ...
        if (m) for (var v in m) r.setRequestHeader(v, m[v]);
        r.send(k);
        return r;
    };
    var g = function (b, c) {
...
filepicker.extend("base64", function () {
    ...
    var b = function (a, b) {
        ...
        while (l < a.length) {
            ...
            c = c + _keyStr.charAt(h) + _keyStr.charAt(i) + _keyStr.charAt(j) + _keyStr.charAt(k);
        }
        return c;
    };
    var c = function (a, b) {
        ...
        while (l < a.length) {
            h = _keyStr.indexOf(a.charAt(l));
            i = _keyStr.indexOf(a.charAt(l + 1));
            j = _keyStr.indexOf(a.charAt(l + 2));
            k = _keyStr.indexOf(a.charAt(l + 3));
            l += 4;
            d = (h << 2) | (i >> 4);
            f = ((i & 15) << 4) | (j >> 2);
            g = ((j & 3) << 6) | k;
            c = c + String.fromCharCode(d);
            if (j != 64) c = c + String.fromCharCode(f);
            if (k != 64) c = c + String.fromCharCode(g);
        }
        if (b) c = e(c);
        return c;
    };
...
filepicker.extend("files", function () {
    ...
    var o = function (b, c, d, e) {
        ...
        a.ajax.get(b + "/metadata", {
            ...
            data: c,
            success: function (a) {
                for (var b = 0; b < f.length; b++) if (a[f[b]]) a[f[b]] = new Date(a[f[b]]);
                d(a);
            },
            error: function (b, c, d) {
...
filepicker.extend("iframeAjax", function () {
    ...
    var j = function (a) {
        ...
        for (var c = 0; c < b.length; c++) {
            ...
            for (var e = 0; e < d.files.length; e++) if (d.files[e] === a) return d;
        }
        return null;
    };
    return {
...
filepicker.extend("json", function () {
    ...
    var f = function (b, c) {
        ...
        if (window.JSON && window.JSON.parse) return window.JSON.parse(b);
            ...
            if (c) if (!d(b)) throw new Error('JSON could not decode the input; security is enabled and the value is not secure.');
            return eval('(' + b + ')');
        }
    };
    return {
...
filepicker.extend('mimetypes', function () {
    ...
    var e = function (b, d) {
        ...
        for (var e = 0; e < c.length; e++) if (b == c[e]) return true;
        test_parts = b.split("/");
...
filepicker.extend("modal", function () {
    ...
    var h = function (d, e) {
        e = !! e;
        return function () {
            if (a.uploading && !e) if (!window.confirm("You are currently uploading. If you choose 'OK', the window will close and your upload will not finish. Do you want to stop uploading and close the window?")) return;
            a.uploading = false;
...
filepicker.extend("picker", function () {
    ...
    var f = function (g, h, i, j) {
        ...
        var q = k + "-upload";
        a.handlers.attach(q, d(function () {
            a.handlers.detach(q);
        }));
    };
    return {
