...
App.Router = Backbone.Router.extend({
	...
	inbox_normal: function(){
		...
		var page;
		if(!App.Data.PermaViews.normal){
			// Create page for first time
			App.Data.PermaViews.normal = new App.Views.Inbox_Normal();
		...
		// Display page
		$('.body_container').html(App.Data.PermaViews.normal.$el);
		App.router.showView('main_view',App.Data.PermaViews.normal, 'normal');
	},


	waiting_on_me: function(){
		// Display the "inbox" (our version of an inbox)

		// Already displaying all?
		// - just refresh
		if(App.router.getView('main_view', 'waiting_on_me')){
			App.router.emitView('main_view', 'refresh');
			return;
		}
		...
		// - some pages just stay in memory, do not get .close unless by force
		var page;
		if(!App.Data.PermaViews.waiting_on_me){
			// Create page for first time
			App.Data.PermaViews.waiting_on_me = new App.Views.Inbox_WaitingOnMe();
		...
		// Display page
		$('.body_container').html(App.Data.PermaViews.waiting_on_me.$el);
		App.router.showView('main_view',App.Data.PermaViews.waiting_on_me, 'waiting_on_me');
	},


	waiting_on_other: function(){
		// Display the "inbox" (our version of an inbox)

		// Already displaying all?
		// - just refresh
		if(App.router.getView('main_view', 'waiting_on_other')){
			App.router.emitView('main_view', 'refresh');
			return;
		}
		...
		// - some pages just stay in memory, do not get .close unless by force
		var page;
		if(!App.Data.PermaViews.waiting_on_other){
			// Create page for first time
			App.Data.PermaViews.waiting_on_other = new App.Views.Inbox_WaitingOnOther();
		...
		// Display page
		$('.body_container').html(App.Data.PermaViews.waiting_on_other.$el);
		App.router.showView('main_view',App.Data.PermaViews.waiting_on_other, 'waiting_on_other');
	},
