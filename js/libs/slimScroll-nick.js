			...
			var isOverPanel, isOverBar, isDragg, queueHide, barHeight, percentScroll,
				...
				*/
				...
				function scrollContent(y, isWheel, isJump)
				{
					...
					var fromTop = parseInt($(me).attr('data-fromtop'));
					if(!fromTop){
						fromTop = 0;
					}
					...
					if (isWheel)
					{
						...
						delta = parseInt(fromTop) + y * wheelStep / 100 * me.outerHeight();
					...
					//percentScroll = parseInt(fromTop) / me.outerHeight();
